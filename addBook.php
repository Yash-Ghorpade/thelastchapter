<?php
     ...
     require 'connection.php';
...

            {
                    ...
                    $author = $_POST['author'];
                    $qtt = $_POST['quantity'];
                    $sql2 = "Insert into book (book_title, book_author, book_quantity) values ('$title','$author','$qtt')";
        ...
        <div class="content-body">
            <div class='container-fluid' style='display:flex;justify-content:center'>
                <div class='wrap-login100' style='margin-bottom:4vh'>
    				<form class='login100-form validate-form' method='POST' action='addBook.php'>
    					<span class='login100-form-title p-b-34 p-t-27'>
    						Book Adder
    					</span>
                    
    					<div class='wrap-input100 validate-input'>
    						<input class='input100' type='text' name='title' placeholder='Book Name'>
    						<span class='focus-input100'><i class='far fa-edit'></i></span>
    					</div>
    
                        <div class='wrap-input100 validate-input'>
    						<input class='input100' type='text' name='author' placeholder='Book Author'>
    						<span class='focus-input100'><i class='far fa-edit'></i></span>
    					</div>
    
    					<div class='wrap-input100 validate-input'>
    						<input class='input100' type='number' name='quantity' placeholder='Book Quantity'>
    						<span class='focus-input100'><i class='far fa-edit'></i></span>
    					</div>
    
    					<div class='col' style='display:flex;justify-content:center; margin-bottom:4vh;margin-top:5vh'>
    						<button class='login100-form-btn' name='edit' type='submit'>
    							Add!
    						</button>
    					</div>
    				</form>
