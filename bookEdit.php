    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="content-body">
            <?php
            echo "<form class='d-none d-sm-inline-block me-auto ms-md-3 my-2 my-md-0 mw-100 navbar-search' method=post action='bookEdit.php' style = 'display:flex;justify-content:center'>
            ...
            if($_SERVER['REQUEST_METHOD'] == 'POST')
            {
                if(isset($_POST['edit']))
                {
                    ...
                    $author = $_POST['author'];
                    $qtt = $_POST['quantity'];
                    $sql2 = "UPDATE book set book_title = '$title', book_author = '$author', book_quantity = '$qtt' where book_srno = '$srno'";
               ...
               <div class='container-fluid' style='display:flex;justify-content:center'>
                <div class='wrap-login100' style='margin-bottom:4vh'>
    				<form class='login100-form validate-form' method='POST' action='bookEdit.php'>
    					<span class='login100-form-title p-b-34 p-t-27'>
    						Book Details Edit
    					</span>
                    
    					<div class='wrap-input100 validate-input'>
    						<input class='input100' type='text' name='title' value = '".$display['book_title']."' placeholder='Book Name'>
    						<span class='focus-input100'><i class='far fa-edit'></i></span>
    					</div>
    
                        <div class='wrap-input100 validate-input'>
    						<input class='input100' type='text' name='author' value = '".$display['book_author']."' placeholder='Book Author'>
    						<span class='focus-input100'><i class='far fa-edit'></i></span>
    					</div>
    
    					<div class='wrap-input100 validate-input'>
    						<input class='input100' type='number' name='quantity' value = '".$display['book_quantity']."' placeholder='Book Quantity'>
    						<span class='focus-input100'><i class='far fa-edit'></i></span>
    					</div>
    
    					<div class='col' style='display:flex;justify-content:center; margin-bottom:4vh;margin-top:5vh'>
    						<button class='login100-form-btn' name='edit' value='".$display['book_srno']."' type='submit'>
    							Edit!
    						</button>
    					</div>
    				</form>
