    ...
    <div style="justify-content:center">
        ...
        <a href='employeeReturning.php'>
            <button class='btn btn-primary'>
                ...
                $sql = "select * from `issue` where employee_srno = '".$display5['employee_srno']."' and issue_status = 'o' group by customer_srno;";
                $result = mysqli_query($conn, $sql);
                    ...
                    while($display = mysqli_fetch_array($result))
                    {
                        ...
                        echo"<div class='accordion' id='myAccordion".$counter."'>
                                <div class='accordion-item'>
                                    ...
                                    <div class='col'>
                                            <p style='color:red'>".$display['order_date']."</p>
                                        </div>
                                        <div class='col'>
                        ...
                        echo "<div style='display:flex;justify-content:right'>
                            <form method='POST' action ='delivery.php'>
                                                <button class='btn btn-primary' name = 'butto' value='".$display['customer_srno']."'>Delivered</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
